...
import ProductView1 from "./ProductView";
  ...
  return (
    <>
      <div className="add-order">
        <div className="close-btn4" id="top-bar-container" onClick={onClose}>
          <button className="x7" id="close-btn" onClick={onClose}>
            <img className="vector-icon18" alt="" src="/vector3.svg" />
            <img className="vector-icon18" alt="" src="/vector4.svg" />
          </button>
        </div>
        <div className="buttons2" id="nav">
        ...
        >
          <div className="product-view2" id="product">
            <img
              className="product-image-icon1"
              alt=""
              src="/product-image11@2x.png"
            />
        ...
        <div className="bottom-bar" id="bottom-bar">
          ...
          <div className="buttons3" id="buttons_container">
            <button
            ...
            <button className="add-to-list-btn1" id="add_btn" onClick={onClose}>
              <div className="vector-wrapper">
                <img className="vector-icon21" alt="" src="/eat.svg" />
              </div>
      ...
      {isProductViewPopupOpen && (
        ...
        >
          <ProductView1 onClose={closeProductViewPopup} />
        </PortalPopup>
      )}
