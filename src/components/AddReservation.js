...
import PortalPopup from "./UI/Order/PortalPopup";
    ...
    <>
      <div className="add-reservation">
        <div className="title" id="title">
          <img className="vector-icon" alt="" src="/fork_icon.svg" />
        ...
        <div className="buttons" id="btn_row">
          <button className="add" id="AddBtn">
            <div className="add1">Add</div>
          </button>
          <button className="close2" id="close_btn">
